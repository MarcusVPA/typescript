...
cleanButton.addEventListener('click', () => { // Percebam que aqui o typescript não acusou o botao de ser nulo e não precisei do if. Caso queiram fazer o teste, retirem a exclamação.
    cleanBalance();
});

/**
    <h4>Valor a ser adicionado: <input id="sum"> </h4>
    <button id="update-balance">Atualizar saldo</button>
    <button id="clean-balance">Limpar seu saldo</button>
    <h1>"Seu saldo é: " <span id="balance-field"></span></h1>
 */